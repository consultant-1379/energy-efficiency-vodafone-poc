...
public class SNMPImpl implements SnmpService, AutoCloseable {
    ...
    private RpcProviderRegistry rpcProviderRegistery;
    private BindingAwareBroker.RpcRegistration<SnmpService> rpcRegistration;
   ...
   /**
    ...
    public void setRpcRegistry(final RpcProviderRegistry rpcProviderRegistry) {
        LOG.info("SNMPImpl.setRpcRegistry");
        this.rpcProviderRegistery = rpcProviderRegistry;
    }

    public void startup() {
        LOG.info("SNMPImpl.startup");
        startSnmp();
	}
    ...
    public void startSnmp(Snmp snmp) {
        Preconditions.checkNotNull(this.rpcProviderRegistery);
        ...
        LOG.info("SNMPImpl.startSnmp: addRpcImplementation SnmpService");
    }
