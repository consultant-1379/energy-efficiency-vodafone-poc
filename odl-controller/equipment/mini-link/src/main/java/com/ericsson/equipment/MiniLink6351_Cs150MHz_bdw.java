...
public enum MiniLink6351_Cs150MHz_bdw {
    acm4Qam_bdw (225, 7, MiniLink_ACM_Flavour.STANDARD),
    acm16Qam_bdw (451, 3, MiniLink_ACM_Flavour.STANDARD),
    acm32Qam_bdw (564, 3, MiniLink_ACM_Flavour.STANDARD),
    acm64Qam_bdw (677, 3, MiniLink_ACM_Flavour.STANDARD),
    acm128Qam_bdw (790, 0, MiniLink_ACM_Flavour.STANDARD),
    ...
    private  MiniLink6351_Cs150MHz_bdw(final Integer bandwidth, final Integer tipfe,
    ...
    public static Integer getInputTargetPowerReduction(final Integer lowValue,
        ...
        for (MiniLink6351_Cs150MHz_bdw type : MiniLink6351_Cs150MHz_bdw.values()) {
