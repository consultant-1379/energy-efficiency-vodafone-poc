...
public enum MiniLink6351_Cs50MHz_bdw {
    acm4Qam_bdw (71, 6, MiniLink_ACM_Flavour.STANDARD),
    acm16Qam_bdw (143, 3, MiniLink_ACM_Flavour.STANDARD),
    acm32Qam_bdw (179, 4, MiniLink_ACM_Flavour.STANDARD),
    acm64Qam_bdw (215, 3, MiniLink_ACM_Flavour.STANDARD),
    acm128Qam_bdw (251, 4, MiniLink_ACM_Flavour.STANDARD),
    acm256Qam_bdw (287, 0, MiniLink_ACM_Flavour.STANDARD);

    private Integer bandwidth;
    private Integer tipfe;
    private MiniLink_ACM_Flavour flavour;

    private MiniLink6351_Cs50MHz_bdw(final Integer bandwidth, final Integer tipfe,
    ...
    public static Integer getInputTargetPowerReduction(final Integer lowValue,
        ...
        for (MiniLink6351_Cs50MHz_bdw type : MiniLink6351_Cs50MHz_bdw.values()) {
