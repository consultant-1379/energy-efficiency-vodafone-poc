...
public enum MiniLink6351_Cs200MHz_bdw {
    acm4Qam_bdw (297, 6, MiniLink_ACM_Flavour.STANDARD),
    acm16Qam_bdw (594, 3, MiniLink_ACM_Flavour.STANDARD),
    acm32Qam_bdw (743, 3, MiniLink_ACM_Flavour.STANDARD),
    acm64Qam_bdw (905, 3, MiniLink_ACM_Flavour.STANDARD),
    acm128Qam_bdw (1056, 0, MiniLink_ACM_Flavour.STANDARD),
    acm256Qam_bdw (-1, 0, MiniLink_ACM_Flavour.STANDARD);

    private Integer bandwidth;
    private Integer tipfe;
    private MiniLink_ACM_Flavour flavour;

    private MiniLink6351_Cs200MHz_bdw(final Integer bandwidth, final Integer tipfe,
    ...
    public static Integer getInputTargetPowerReduction(final Integer lowValue,
        ...
        for (MiniLink6351_Cs200MHz_bdw type : MiniLink6351_Cs200MHz_bdw.values()) {
