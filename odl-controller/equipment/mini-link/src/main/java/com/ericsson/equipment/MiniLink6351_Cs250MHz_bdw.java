...
public enum MiniLink6351_Cs250MHz_bdw {
    acm4Qam_bdw (374, 8, MiniLink_ACM_Flavour.STANDARD),
    acm16Qam_bdw (748, 3, MiniLink_ACM_Flavour.STANDARD),
    acm32Qam_bdw (950, 3, MiniLink_ACM_Flavour.STANDARD),
    acm64Qam_bdw (1140, 0, MiniLink_ACM_Flavour.STANDARD),
    acm128Qam_bdw (-1, 0, MiniLink_ACM_Flavour.STANDARD),
    ...
    private MiniLink6351_Cs250MHz_bdw(final Integer bandwidth, final Integer tipfe,
    ...
    public static Integer getInputTargetPowerReduction(final Integer lowValue,
        ...
        for (MiniLink6351_Cs250MHz_bdw type : MiniLink6351_Cs250MHz_bdw.values()) {
